...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(powerline-active1 ((,class (:background ,nox-purple))))
   `(powerline-active2 ((,class (:background ,nox-bg-dark))))
   ...
   `(ledger-font-xact-highlight-face ((,class (:background ,nox-bg-subtle))))
   ;; Elfeed faces
