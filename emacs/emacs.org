...
#+NAME: init-before
#+BEGIN_SRC emacs-lisp :tangle no
  (defvar my-ephemeral-directory "~/.emacs.ephemeral/")
  (unless (file-exists-p my-ephemeral-directory)
    (mkdir my-ephemeral-directory))
#+END_SRC
...
#+NAME: init-after
#+BEGIN_SRC emacs-lisp :tangle no
  (setq eshell-directory-name (expand-file-name "eshell/" my-ephemeral-directory))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle no
  (use-package saveplace
    ...
    (progn
      ...
      (setq save-place-file (expand-file-name "saved-places" my-ephemeral-directory))))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle no
  (use-package ido
    :init
    (progn
      (setq ido-save-directory-list-file (expand-file-name "ido.last" my-ephemeral-directory))
    :config
    (progn
      (ido-mode t)
      (ido-everywhere t)
...
#+BEGIN_SRC emacs-lisp :tangle no
  (use-package smex
    ...
    :config
    (progn
      (setq smex-save-file (expand-file-name "smex-items" my-ephemeral-directory))
...
#+BEGIN_SRC emacs-lisp :tangle no
  (use-package auto-complete-config
    ...
    (progn
      ...
      (setq ac-comphist-file (expand-file-name "ac-comphist.dat" my-ephemeral-directory)
...
#+BEGIN_SRC emacs-lisp :tangle no
  ...
  Ledger expects. Includes a custom prompt string."
      ...
      ;;
      ;; (defun my-make-org-capture-mode-evil ()
...
#+BEGIN_SRC emacs-lisp :tangle no
  (use-package org-clock
    :config
    (progn
      (setq org-clock-persist-file (expand-file-name ".org-clock-save.el" my-ephemeral-directory)
            org-clock-persist t
