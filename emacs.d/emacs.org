...
Maildir format. It's more minimalistic than the popular Gnus, but
includes the features I need:

- Email threads
- Flexible search
- Integration with Org mode

Since I haven't quite figured out a suitable setup, this package is
  ...
  (use-package mu4e
    ...
    (progn
      (setq mu4e-sent-folder "/Sent"
            ...
            mu4e-headers-include-related t ; Thread messages
            mail-user-agent 'mu4e-user-agent))) ; Make mu4e default mail client
#+END_SRC
