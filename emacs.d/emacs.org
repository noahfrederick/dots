...
Set the initial text contents of the =*scratch*= buffer:
...
Show line numbers in programming modes with a format that allows
for five digits with some padding to the right of the numbers.
