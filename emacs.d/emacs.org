...
** Platform-specific
   ...
   #+BEGIN_SRC emacs-lisp :tangle no
     (cond ((eq system-type 'darwin)
            ...
            ;; Correctly parse exec-path when PATH deleimiter is a space
...
** UI
   ...
   Here we load the theme, which determines colors and font
   variants. Enox is a medium-contrast theme with a dark background.
   ...
   #+BEGIN_SRC emacs-lisp :tangle no
     ...
     (use-package whitespace
       ...
       (progn
         ...
         (evil-leader/set-key "ol" 'whitespace-mode))
       :config
       (progn
